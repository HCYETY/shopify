  function isMobile() {
    ...
    const switList = [
      {
        title: "20W Blau Laser",
        desc: "Leistungsstarkes Schneiden & Gravieren",
        children: [
          {
            switchName: "Holz",
            pcImg:
      ...
      {
        title: "2W IR Laser",
        desc: "Erschließt neue Möglichkeiten auf Metallen & Kunststoffen",
        children: [
          {
            switchName: "Acryl",
            pcImg:
    ...
    const rowTabsWrapList = [
      {
        title: "20W Blaulaser",
        subtitle: "Professionelle Ergebnisse",
        desc: "  10mm Lindenholz, <br />8mm schwarzes Acryl,<br />  0,04mm Edelstahlblech.<br/>Arbeitsgeschwindigkeit bis 600mm/s.",
        videoUrl:
          "https://cdn.shopify.com/videos/c/o/v/b07e771090dd4b23bfee24d4cd9af43f.mp4",
      },
      {
        title: "2W IR-Laser",
        subtitle: "Ultra-HD Gravur",
        desc: " Mit <span> 0,03mm ultrafeinem Laserpunkt</span> und <span> 1064nm IR-Technologie</span> für einzigartige Detailtreue bei Fotos, Schmuck, Visitenkarten u.v.m.",
        videoUrl:
    ...
    const section13TabsList = [
      {
        title: "Konturenzeichnen • Handschrift • Skizzen",
        desc: "Erfasst präzise alle Konturen Ihrer Vorlagen per HD-Kamera – für einzigartige, persönliche Kreationen.",
        videoUrl:
          "https://cdn.shopify.com/videos/c/o/v/0ac4bdbabb094cfabefbc256fa1f8df8.mp4",
      },
      {
        title: "Stapelgravur",
        desc: "Automatische Formerfassung per Kamera mit Mustergenerierung für Mehrfachobjekte",
        videoUrl:
